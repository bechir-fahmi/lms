...
<style>
    ...
    .btn-two.arrow-btn.submit-instructor-btn {
    ...
    .btn-two.arrow-btn.submit-instructor-btn:hover {
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="singUp-wrap">
                        ...
                        <form method="POST" action="{{ route('become-instructor.create') }}" class="account__form" enctype="multipart/form-data">
                            ...
                            @endif
                            <button type="submit" class="btn btn-two arrow-btn submit-instructor-btn">{{ userAuth()->role == 'instructor' ? __('Submit') : __('Submit for Review') }}<img
