                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="footer__widget">
                        <div class="logo mb-35">
                            <a href="{{ route('home') }}" style="font-size: 28px; font-weight: 700; color: #8EC3D4; text-decoration: none; font-family: Arial, sans-serif; display: inline-block;">fluttIris</a>
                        </div>
