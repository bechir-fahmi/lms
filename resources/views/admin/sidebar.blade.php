<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}" style="font-size: 24px; font-weight: 700; color: #8EC3D4; text-decoration: none; font-family: Arial, sans-serif; display: block; padding: 15px 0;">fluttIris</a>
        </div>

        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('admin.dashboard') }}" style="font-size: 18px; font-weight: 700; color: #8EC3D4; text-decoration: none; font-family: Arial, sans-serif;">FI</a>
        </div>
